...
public class CameraLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Rotamos todo el cuerpo del jugador, no solo la cámara.
        playerBody.Rotate(Vector3.up * mouseX);

        // --- Rotación Vertical (Arriba/Abajo) ---
        // Restamos mouseY porque el eje Y del ratón es invertido por defecto.
        xRotation -= mouseY;
        ...
        // Usamos Quaternion.Euler para convertir el ángulo a una rotación.
